        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="gap-5 items-start flex">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg w-1/2 p-4">
                    ...
                    <div>
                        <form class="max-w-sm mx-auto" method="POST" action="{{ route('member.store') }}">
                            @csrf
                            <div class="mb-5">
                                <label for="nama"
                                ...
                                <input type="text" name="nama"
                                    ...
                                    required placeholder="Masukkan Nama Member" />
                            </div>
                            <div class="mb-5">
                                <label for="alamat"
                                        ...
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 px-4"
                                            ...
                                            <td class="px-5 py-3">
                                                <button type="button"
                                                    ...
                                                    data-jenis_kelamin="{{ $f->jenis_kelamin }}">
                                                    <i class="fi fi-sr-file-edit"></i>
                                                </button>
                                                <button
                                                    class="bg-red-400 p-3 w-10 h-10 rounded-xl text-white hover:bg-red-500"
                                                    onclick="return memberDelete('{{ $f->id }}','{{ $f->nama }}')">
